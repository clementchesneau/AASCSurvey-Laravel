...
@section('content')
    ...
    <div id="bodyindex">
        ...
        <div class="container ">
            <div class="p-3">
                <h1 class="text-white text-center my-auto ">{{ __('messages.surveys.index.forms') }}</h1>

                <div class="d-flex justify-content-center">
                    <div class="p-2">
                        <button type="button" class="btn btn-secondary mb-2 noborder">{{ __('messages.surveys.index.nbsond') }}
                            <span class="badge badge-light">{{ count($surveys) }}</span>
                        </button>
                    </div>
                    
                    <div class="p-2">
                        <button type="button" class="btn btn-secondary mb-2 noborder">{{ __('messages.surveys.index.nbpart') }}
                            <span class="badge badge-light">{{ $answersnb }}</span>
                        </button>
                    </div>
                </div>
            ...
            @if(! $surveys->isEmpty())
                ...
                <!-- /.row -->
            @else
                <!-- Modal pas de formulaire -->
                <div class="modal fade noborder" id="modalnoform" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog noborder" role="document">
                        <div class="modal-content noborder">
                            <div class="modal-header color45464B noborder">
                                <h3 class="modal-title col-12 modal-title text-center text-white" id="exampleModalLabel">{{ __('messages.surveys.index.mince') }}</h3>
                            </div>

                            <div class="modal-body border text-center">
                                <h5>{{ __('messages.surveys.index.aucun') }}</h5>
                            </div>
